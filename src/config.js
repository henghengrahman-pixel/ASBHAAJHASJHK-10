...
export const config = {
  ...
  // Structured agent decisions carry more fields than a normal CS reply. Keep a separate
  // floor so JSON is not truncated mid-object when OPENAI_MAX_OUTPUT_TOKENS is tuned low.
  openaiJsonMaxOutput: Math.max(512, int(process.env.OPENAI_JSON_MAX_OUTPUT_TOKENS, 900)),
